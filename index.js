...
d3.csv("https://raw.githubusercontent.com/Bryrant93/OscarVisualisations/main/winnersFrame9.csv").then( function(data1) {
  ...
  svg1.append("g")
    ...
    svg1.append("line").attr("x1", 883).attr("y1",324.5).attr("x2",1060).attr("y2",324.5).style("stroke", "white").style("stroke-dasharray", "8,4").style("stroke-width", 3).style("opacity",0).transition().duration(1500).style("opacity",1)
    svg1.append("text").attr("x", 883).attr("y", 305).text("Only two Academy Awards Ceremonies ").style("font-size", "12.5px").attr("alignment-baseline","middle").attr("fill", "#f5f5f5").style("opacity",0).transition().duration(1500).style("opacity",1)
    svg1.append("text").attr("x", 883).attr("y", 317).text("have taken place so far this decade.").style("font-size", "12.5px").attr("alignment-baseline","middle").attr("fill", "#f5f5f5").style("opacity",0).transition().duration(1500).style("opacity",1)
